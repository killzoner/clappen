...
// a parent that has both a default_prefix and a flattened child: the parent's default prefix
// travels down the chain and prefixes the child's type and fields
...
mod api {
    ...
    pub struct ServerOptions {
        pub url: String,
        #[clappen_command(apply = server, prefix = "test")]
        pub server: Server,
    }
...
fn from_nested_under_default_prefix() {
    let value = MainApiServerOptions {
        ...
        main_api_server: __inner_main_api_server::MainApiTestServer {
            main_api_test_host: String::from("7"),
        },
    };
    assert_eq!(
        ...
        ApiServerOptions {
            ...
            api_server: __inner_api_server::ApiTestServer {
                api_test_host: String::from("7")
            },
        }
    );
}
